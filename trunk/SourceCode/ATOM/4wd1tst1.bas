...
main:
if in4 = 0 then right_turn		'A button increments steering variable by 10% each press.
if in5 = 0 then throttle_up		'B button increments then decrements speed variable by 10% each press. 
if in6 = 0 then left_turn		'C button decrements steering variable by 10% each press.
' Send out the servo pulses	
	pulsout 12,(-throttle*10)	' Left Scorpion channel.
	pulsout 13,(throttle*10)	' Right Scorpion channel.
	'sound P9, [100\100]
	pause 20
...
right_turn:
'sound 9, [100\988]
 if in4 = 0 then right_turn
  steering = (steering -5) min 100
goto main

left_turn:
'sound 9, [100\1046]
 if in6 = 0 then left_turn
